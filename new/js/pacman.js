    ...
    PacmanStage.prototype.createStage = function(){
    ...
    PacmanStage.prototype.movePlayerById=function(id){
          this.animatePlayer(this.playersArray[id]);
    }
    
    PacmanStage.prototype.animatePlayer=function (playerToMove){
    ...
    PacmanStage.prototype.checkForBlockStage=function (x,y,player){
